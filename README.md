...
depglass is a C# project for developer tools. It focuses on this technical goal: Explore dependency graphs, cycle detection, and topological layers.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 165, risk penalty 7, latency penalty 3, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
