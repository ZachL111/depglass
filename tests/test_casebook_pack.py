"""Regression checks for the depglass casebook."""
...
from casebook.harness import assert_expected, depglass_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(depglass_summary(), assert_expected())
